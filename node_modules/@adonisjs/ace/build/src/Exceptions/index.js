...
exports.InvalidCommandException = exports.InvalidFlagException = exports.MissingArgumentException = void 0;
...
class InvalidCommandException extends utils_1.Exception {
    ...
    handle(error) {
        ...
        cliui_1.logger.log('');
        const suggestionLog = cliui_1.sticker().heading('Did you mean one of these?');
