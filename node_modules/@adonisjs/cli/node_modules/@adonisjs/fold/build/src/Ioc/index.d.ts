 ...
 * DI simpler.
 */
export declare class Ioc<ContainerBindings extends any> implements IocContract<ContainerBindings> {
    private emitEvents;
    /**
     * For emitting emits
     */
     ...
     */
    clearAutoloadCache(namespace?: string, clearModulesCache?: boolean): void;
    /**
     ...
     * ```
     */
    use<Namespace extends keyof ContainerBindings>(node: Namespace): ContainerBindings[Namespace];
     ...
     */
    make<Namespace extends keyof ContainerBindings>(node: Namespace, args?: any[]): ContainerBindings[Namespace];
